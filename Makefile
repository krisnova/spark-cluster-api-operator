...
TARGET = spark-cluster-api-operator
...
compile: ## Compile the binary
	go build -o bin/spark-cluster-api-operator main.go

install: ## Create the executable
	install -m 0755 bin/spark-cluster-api-operator ${GOPATH}/bin/spark-cluster-api-operator
